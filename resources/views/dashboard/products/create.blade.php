                ...
                <form role="form" method="POST" action="{{ route('product.store') }}" id="productForm"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name-="available_count" placeholder="ex: 20"
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" multiple class="form-control" id="product_image" name="product_image"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name-="each_box_contains" placeholder="ex: 60 pcs"
                        ...
                        <div class="row">
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="text" class="form-control" name="freshness_duration" placeholder="ex: 03 days"
                                value="{{ old('ProductBrief') }}" required>
                            </div>
                            <div class="col-md-5 mb-3">
                                <label for="when_packeting">When Packeting</label>
                                <input type="text" class="form-control" name="when_packeting" placeholder="ex: without touch of hand"
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="same-address">Is Awsome</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="same-address">
                            <label class="custom-control-label" for="same-address">Quality Checking</label>
                        </div>
